...
export default function ForgotPasswordPage() {
  ...
  return (
    <>
      <Toaster />
      <Navbar />
      <main className="p-4 lg:p-8 max-w-md mx-auto sm:min-h-screen flex flex-col justify-center items-center pt-24 sm:pt-1 max-lg:landscape:py-24" role="main" aria-label="Esqueceu a senha">
        <Form {...form}>
          <form
